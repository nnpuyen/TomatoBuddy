  ...
  const fetchImages = async (currentFilters: ApiFilters = filters) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/data/images?${params.toString()}`
      );
      ...
      setError(
        "⚠️ Failed to fetch image data. Please check your connection and try again."
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="grid grid-cols-5 gap-4 items-end">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setLocalFilters((prev) => ({ ...prev, prediction: value }))
                }
              >
                <SelectTrigger>
              ...
              <CardContent className="p-0">
                  ...
                  <div className="relative w-full h-48 bg-gray-100 rounded-t-lg overflow-hidden">
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        target.src =
                          "/placeholder.svg?height=200&width=250&text=Image+Not+Found";
                      }}
                    />
                    {/* Hover overlay */}
                ...
                <div className="p-3">
                  ...
                  <p className="text-xs text-gray-500">
                    Captured at {formatTimestamp(item.timestamp)}
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <Card className="bg-gray-50">
          <CardContent className="p-4">
            <div className="flex justify-between items-center text-sm text-gray-600">
              <span>
                Showing {images.length} images • Click any image to view larger
              </span>
              <span>
                Filters:{" "}
                {localFilters.prediction !== "all"
                  ? `${localFilters.prediction}`
                  : "All predictions"}
